<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <x-ui.card>
                <form method="POST" action="{{ route('admin.work-units.store') }}" class="space-y-5">
                    @csrf

                    {{-- Kompartemen (filter saja, bukan input form) --}}
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">Kompartemen</label>
                        <select id="compartment_filter" class="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option value="">-- Pilih Kompartemen terlebih dahulu --</option>
                    ...
                    <div>
                        ...
                        <select id="department_id" name="department_id" required
                            ...
                            <option value="">-- Pilih Kompartemen dahulu --</option>
