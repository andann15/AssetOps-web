<x-app-layout>
    <x-slot name="header">
        <x-ui.page-header title="Tambah Prioritas Tiket" />
    </x-slot>

    <div class="py-6">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <x-ui.card>
                <form method="POST" action="{{ route('admin.ticket-priorities.store') }}" class="space-y-4">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="sla_hours" id="sla_hours" value="{{ old('sla_hours') }}" min="1"
                               class="block w-full rounded-md border-gray-300 shadow-[0_8px_30px_rgb(0,0,0,0.04)] focus:border-orange-400 focus:ring-orange-400 text-sm">
