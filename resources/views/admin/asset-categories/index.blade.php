        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:rounded-lg p-6">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-medium">Daftar Kategori Aset</h3>
                    <a href="{{ route('admin.asset-categories.create') }}" class="px-4 py-2 bg-sidebar text-white hover:bg-orange-500 hover:text-white transition-colors duration-200 border border-transparent hover:bg-brand/90 border border-transparent text-white rounded ">
                        Tambah Kategori
                    </a>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($assetCategories as $category)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right space-x-2">
                                    <a href="{{ route('admin.asset-categories.edit', $category) }}" class="text-blue-600 hover:underline">Edit</a>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-4 py-3 text-center text-gray-500">Belum ada data kategori aset.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
